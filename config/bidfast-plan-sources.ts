...
export const BIDFAST_PLAN_SOURCES: PlanSource[] = [
  ...
  },
  {
    ...
    allowedHosts: ['ftp.orangecountyfl.net', 'www.orangecountyfl.net', 'orangecountyfl.net'],
  ...
  },
  {
    ...
    allowedHosts: ['www.fdot.gov', 'fdot.gov'],
  ...
  },
  {
    ...
    allowedHosts: ['www.txdot.gov', 'txdot.gov'],
    accessClass: 'PUBLIC_WITH_LICENSE_ACCEPTANCE',
    sourceKind: 'state',
  ...
  },
  {
    ...
    allowedHosts: ['www.palmbeachschools.org', 'palmbeachschools.org'],
